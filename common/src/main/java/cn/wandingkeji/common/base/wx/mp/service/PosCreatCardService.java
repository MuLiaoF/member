 ...
 * 创建会员卡的service
 */
public class PosCreatCardService extends BaseAPIService {

    public PosCreatCardService(String access_token) {
     ...
     * @return API返回的JSON数据
     */
    public String request(Map<String, CreatCardReq> card) {
